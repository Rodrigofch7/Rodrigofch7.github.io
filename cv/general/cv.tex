...
\begin{itemize}
  \item Built a digitization pipeline for century-old fire insurance registers, cloth-bound volumes that had never been machine-readable, covering page segmentation, OCR, and structured extraction.
...
\begin{itemize}
  ...
  \item Reconciled administrative records from several government sources, resolving mismatched identifiers and gaps in coverage so the panels aligned across two decades. Without that step the privatization analysis would not have been identifiable.
...
\skillrow{Languages}{Portuguese (Native), English (Fluent, TOEFL 112/120), Spanish (Professional Working), German (Conversational)}
